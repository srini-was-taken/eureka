  ...
  async function evaluate() {
    ...
    try {
      const res = await fetch("/api/feynman/evaluate", {
        ...
        body: JSON.stringify({ topic, explanation, sourceMaterial: "" }),
      });
        ...
        {stage === "feedback" && feedback && (
          <>
            ...
            <Card style={{ padding: 22, background: "#818cf810", border: "1px solid #818cf830", marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 14, lineHeight: 1.7, margin: 0, color: TEXT }}>{feedback.followUp}</p>
              <textarea
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <Btn variant="ghost" onClick={() => { setStage("pick"); setTopic(""); setExplanation(""); setFeedback(null); }}>Different topic</Btn>
            </div>
          </>
        )}
      </div>
