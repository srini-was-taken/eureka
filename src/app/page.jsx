...
function SocraticBentoCard() {
  return (
    <BentoCard className="sc" style={{ gridColumn: "1 / 3", gridRow: "1" }}>
      <div>
      ...
      <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
        ...
        <GifPlaceholder label="Socratic Demo" aspect="16/9" style={{ width: "50%", flexShrink: 0 }} />
      </div>
    </BentoCard>
  );
}
...
function MistakeBentoCard() {
  return (
    <BentoCard className="sc" style={{ gridColumn: "3", gridRow: "1" }}>
      <div>
...
function FocusBentoCard() {
  return (
    <BentoCard className="sc" style={{ gridColumn: "1", gridRow: "2" }}>
      ...
      <GifPlaceholder label="Focus Demo" aspect="16/9" style={{ width: "100%", marginTop: "auto" }} />
    </BentoCard>
  );
}
