...
Problems can be tricky with time-pressure. For Aptitude/English, guide the student with
clear reasoning patterns. For science subjects, keep hints concise but thorough.`,
    },
    neet: {
        label: "NEET",
